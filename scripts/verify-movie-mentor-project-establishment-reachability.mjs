...
assert.equal(calls.length, 3, "RED: one live creator request must establish project exactly once before sync and turn");
...
assert.equal(calls.filter(call => call.url.endsWith("/api/movie-mentor/projects")).length, 1, "RED: a live request must not duplicate project establishment");
