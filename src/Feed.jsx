...
startLiveY: toPxNumber(layoutValues.liveY, 0),
  ...
  return [
    ...
    `  hubX: ${layoutValues.hubX},`,
    `  hubY: ${layoutValues.hubY},`,
    `  hubScale: ${layoutValues.hubScale},`,
    `  liveX: ${layoutValues.liveX},`,
    `  liveY: ${layoutValues.liveY},`,
    `  liveScale: ${layoutValues.liveScale},`,
    `  aiX: ${layoutValues.aiX},`,
    `  aiY: ${layoutValues.aiY},`,
    `  aiScale: ${layoutValues.aiScale},`,
...
>
  <img
    ...
    style={{
      ...
      boxShadow:
        "0 0 18px rgba(124,58,237,0.30), 0 0 34px rgba(234,88,12,0.18), 0 8px 18px rgba(0,0,0,0.38)",
  ...
  item.label === "Upload"
    ...
    : item.label === "Inbox"
      ...
      : item.label === "Home"
        ? 33 * layoutValues.bottomNavScale
        : item.label === "Shop"
          ? 47 * layoutValues.bottomNavScale
          : item.label === "Profile"
            ? 33 * layoutValues.bottomNavScale
  ...
  item.label === "Upload"
    ...
    : item.label === "Home"
      ...
      : item.label === "Shop"
        ...
        : item.label === "Inbox"
          ? 55 * layoutValues.bottomNavScale
          : item.label === "Profile"
...
<div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
  ...
  <Stepper
    ...
    onMinus={() => adjustScale("rightRailAvatarScale", -0.05, 0.7, 1.6)}
    onPlus={() => adjustScale("rightRailAvatarScale", 0.05, 0.7, 1.6)}
  />
